...
const useTask = () => {
    ...
    const getPendingUnassignedTask = useCallback(
        async (payload: getAllunAssignedTaskPayload): Promise<TaskResponse> => {
            setIsLoading(true)
            try {
    ...
    const getCompletedTasks = useCallback(
        async (payload: getCompletedTaskPayload): Promise<TaskResponse> => {
            setIsLoading(true)
            try {
    ...
    const getOneTaskById = useCallback(
        async (task_id: string): Promise<SingleTaskResponse> => {
            setIsLoading(true)
            try {
