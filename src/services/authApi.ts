...
export const authApi = {
    ...
    forgotPassword: async (email: string): Promise<AuthResponse> => {
        try {
            const response = await fetch(`${API_BASE_URL}/responder/forgot-password`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    changePassword: async (
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/responder/change-password`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
                },
                body: JSON.stringify({ old_password, new_password , confirm_password, user_id }),
            });
